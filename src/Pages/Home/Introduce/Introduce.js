...
const Introduce = () => {
    return (
        <div className="hero min-h-screen bg-purple-50 shadow-inner mt-24">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div data-aos="fade-up-left">
                    ...
                    <a href="https://drive.google.com/file/d/1oJdx4ZocNADyjII72Yi8BueQZ0PZvEdJ/view?usp=share_link"><button className="bg-neutral-800 text-white rounded py-3 rounded w-36 font-bold hover:bg-gray-500 border">DOWNLOAD CV</button></a>
                </div>
            </div>
        </div>
    );
