        ...
        <div className="hero min-h-screen bg-base-200 mt-24">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div data-aos="fade-up-left">
                    ...
                    <a href="https://drive.google.com/file/d/1xqbGIZYUJH7Zl_KYU3oW4ZiXv52JCi5e/view?usp=share_link"><button className="btn btn-secondary w-36 font-bold">DOWNLOAD CV</button></a>
                </div>
            </div>
        </div>
    );
